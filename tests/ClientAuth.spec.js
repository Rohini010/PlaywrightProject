    ...
    const card_titles= page.locator(".card-body b");
    ...
    await page.locator("input[type='lastName']").fill("test");

    await userEmail.fill(emailValue);
    await page.locator("input[id='userMobile']").fill("9087543124");
    await password.fill(passwordValue);
    await page.getByPlaceholder("Confirm Passsword").fill(passwordValue);
...
await page.locator("div li").first().waitFor();
   ...
   console.log(bool);
    ...
    const country= await result.locator("button").allTextContents();
    // console.log(country)
